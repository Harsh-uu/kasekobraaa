...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ...
      : "https://kasekobraaa-seven.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing everything for your delivery and will notify you
              once your package has been shipped. Delivery usually takes 2 days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any quesitons regarding your order, please feel free
